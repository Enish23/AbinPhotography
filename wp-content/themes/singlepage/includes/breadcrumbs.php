...
function singlepage_breadcrumbs( $args = array() ) {
if ( function_exists( 'is_bbpress' ) && is_bbpress() )
	$breadcrumb = new bbPress_Singlepage_Breadcrumb( $args );
else
	$breadcrumb = new Singlepage_Breadcrumb( $args );
...
/* Labels for text used (see Singlepage_Breadcrumb::default_labels). */
'labels' => array()
);
...
$breadcrumb = apply_filters( 'singlepage_breadcrumbs', $breadcrumb, $this->args );
...
$parents[] = '<a href="' . esc_url(get_term_link( $term, $taxonomy )) . '" title="' . esc_attr( $term->name ) . '">' . esc_attr( $term->name ) . '</a>';
...
$this->items[] = '<a href="' . esc_url(get_term_link( $term, 'category' )) . '" title="' . esc_attr( $term->name ) . '">' . esc_attr($term->name) . '</a>';
}
}
}
}
...
/**
* Extends the Singlepage_Breadcrumb class for bbPress. Only use this if bbPress is in use. This should
* serve as an example for other plugin developers to build custom breadcrumb items.
*
* @access public
*/
class bbPress_Singlepage_Breadcrumb extends Singlepage_Breadcrumb {
/**
