...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'singlepage' ),
				'change'       => esc_attr__( 'Change image', 'singlepage' ),
				'default'      => esc_attr__( 'Default', 'singlepage' ),
				'remove'       => esc_attr__( 'Remove', 'singlepage' ),
				'placeholder'  => esc_attr__( 'No image selected', 'singlepage' ),
				'frame_title'  => esc_attr__( 'Select image', 'singlepage' ),
				'frame_button' => esc_attr__( 'Choose image', 'singlepage' ),
			)
		);
	}
