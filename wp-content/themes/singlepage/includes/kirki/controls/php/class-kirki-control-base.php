...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'singlepage' ),
				'remove'         => esc_attr__( 'Remove', 'singlepage' ),
				'default'        => esc_attr__( 'Default', 'singlepage' ),
				'selectFile'     => esc_attr__( 'Select File', 'singlepage' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'singlepage' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'singlepage' ),
			)
		);
