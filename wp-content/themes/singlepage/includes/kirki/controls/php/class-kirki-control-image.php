...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'singlepage' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'singlepage' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'singlepage' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'singlepage' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'singlepage' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'singlepage' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'singlepage' ); ?>',
		} );
		#>
		<label>
