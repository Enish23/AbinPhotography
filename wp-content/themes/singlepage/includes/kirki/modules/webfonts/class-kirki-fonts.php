...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'singlepage' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'singlepage' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'singlepage' ),
			'200'       => esc_attr__( 'Light 200', 'singlepage' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'singlepage' ),
			'300'       => esc_attr__( 'Book 300', 'singlepage' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'singlepage' ),
			'400'       => esc_attr__( 'Normal 400', 'singlepage' ),
			'regular'   => esc_attr__( 'Normal 400', 'singlepage' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'singlepage' ),
			'500'       => esc_attr__( 'Medium 500', 'singlepage' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'singlepage' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'singlepage' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'singlepage' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'singlepage' ),
			'700'       => esc_attr__( 'Bold 700', 'singlepage' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'singlepage' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'singlepage' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'singlepage' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'singlepage' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'singlepage' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'singlepage' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'singlepage' ),
		);
	}
